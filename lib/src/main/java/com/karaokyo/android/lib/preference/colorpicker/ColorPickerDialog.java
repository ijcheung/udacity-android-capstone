...
public class ColorPickerDialog {
	 ...
	 * @param listener an OnColorPickedListener, allowing you to get back error or OK
	 */
	public ColorPickerDialog(final Context context, int color, OnColorPickedListener listener) {
	 ...
	 */
	public ColorPickerDialog(final Context context, int color, boolean supportsAlpha, OnColorPickedListener listener) {
